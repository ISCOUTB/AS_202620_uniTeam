...
| A-02 | Asignar tareas a integrantes del equipo | RF-02 | Seguridad | [ESC-03](calidad/escenarios-calidad.md#esc-03) |[ADR-003 — Selección del estilo arquitectónico](adr/ADR-003-...)| Asignar exige saber quién pertenece al proyecto; ahí es donde el control de acceso entre proyectos se pone a prueba. |
...
| A-04 | Definir estados de las tareas | RF-04 | Modificabilidad | [ESC-05](calidad/escenarios-calidad.md#esc-05) |[ADR-003 — Selección del estilo arquitectónico](adr/ADR-003-...)| El flujo de estados es lo que más va a cambiar: cada equipo trabaja distinto. |
| A-05 | Establecer fechas límite | RF-05 | Disponibilidad | [ESC-04](calidad/escenarios-calidad.md#esc-04) |[ADR-003 — Selección del estilo arquitectónico](adr/ADR-003-...)| El valor de la fecha límite se concentra en la semana de entregas, que es cuando el sistema no puede estar caído. |
| A-06 | Consultar el progreso de las actividades | RF-06 | Rendimiento |[ESC-01](calidad/escenarios-calidad.md#esc-01) |[ADR-003 — Selección del estilo arquitectónico](adr/ADR-003-...)| Consultar el avance debe ser más rápido que preguntar por el chat; si no, el aspecto no aporta valor. |
...
- [ADR-003 — Selección del estilo arquitectónico](adr/ADR-003-...)
